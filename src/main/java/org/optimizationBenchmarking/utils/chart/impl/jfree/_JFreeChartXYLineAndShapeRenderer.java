 ...
 * </p>
 */
final class _JFreeChartXYLineAndShapeRenderer
    extends XYLineAndShapeRenderer implements DrawingSupplier {
   ...
   */
  @Override
  public final boolean getItemShapeVisible(final int series,
      final int item) {
    return false;
  }
}
